...
with col1: mode = st.radio("回測深度", ["最近資料"])
...
start_dt = df_raw['datetime'].iloc[0].strftime('%Y-%m-%d')
metrics, trades = tester.run_strategy(start_dt, session, sl_points, tp_points)
